  ...
  return (
    <div className='bg-[#20293a] w-screen h-full relative md:h-full lg-h-full px-[10%]  '>
      ...
      <div className='pt-22 flex flex-col gap-5  md:flex-row  md:items-start md:pt-3 md:justify-start md:pl-32  lg:justify-start lg:pl-40'>
        <div className='flex gap-3 bg-[#111629] w-43 h-12 rounded-xl text-[15px] items-center justify-center text-white/70'>
        <p>Followers</p>
        <p> | </p>
        <span>{user.followers}</span>
      </div>
      <div className='flex gap-3 bg-[#111629] w-35 h-12 rounded-xl text-[15px] items-center justify-center text-white/70'>
        <p>Following</p>
        <p> | </p>
        <span>{user.following}</span>
      </div>
      <div className='flex gap-3 bg-[#111629] w-64 h-12 rounded-xl text-[15px] items-center justify-center text-white/70'>
        <p>Location</p>
        <p> | </p>
